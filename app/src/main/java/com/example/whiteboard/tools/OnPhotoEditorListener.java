...
public interface OnPhotoEditorListener {
     ...
     */
    void onTextMoveListener(float deltaX, float deltaY, String viewTag);
     ...
     * @see ViewType
     */
    void onAddViewListener(String text, String tagName);
    void onAddCommentListener(float x, float y , String tagName);
    /**
     ...
     * @param numberOfAddedViews number of views currently added
     */
    void onRemoveViewListener(String tagName);
